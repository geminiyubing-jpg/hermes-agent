...
class FeishuAdapter(BasePlatformAdapter):
    ...
    MAX_MESSAGE_LENGTH = 32000  # local: raised from 8000 for long-form content (local commit 07-02)
    CHAT_LOCK_MAX_SIZE: int = 1000  # distinct chat IDs kept in _chat_locks before LRU eviction
    _SPLIT_THRESHOLD = 8000  # local: chunk length using longer send delay (was 4000)
